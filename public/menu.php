  ...
  <body>
    ...
    <div class="content-body">
      <div class="position-relative">
        <div
          class="mt-0 sidebar-left w3-sidebar w3-light-grey w3-bar-block shadow-0"
          style="width: 225px"
        >
          <h3
            class="w3-bar-item py-2 d-flex justify-content-between align-items-center sidebar-menu"
          >
            Menu
          </h3>
      ...
      >
        <div
          style="z-index: 1"
          class="position-absolute top-0 start-0 w-100 d-flex align-items-center gap-3 p-2 bg-light border-bottom shadow-sm"
        >
          <div class="d-flex gap-2 w-100">
            <span
              class="fs-5 border rounded mb-0 px-3 py-2 border-dark bar-icon"
              ><i class="fa-solid fa-bars"></i
            ></span>
            <span
              class="fs-5 border rounded mb-0 px-3 py-2 border-dark cart-icon"
        ...
        <div
          style="height: 100%; padding: 5rem 1rem 1.2rem 1rem"
          class="w-100 d-flex gap-2 flex-wrap justify-content-center align-items-start overflow-scroll position-relative"
        >
      ...
      <div class="aside">
        <div
          class="px-3 sidebar-right w3-sidebar w3-light-grey w3-bar-block shadow-0 overflow-y-scroll"
        >
