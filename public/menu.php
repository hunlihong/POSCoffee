...
<body>
  ...
  <div class="content-body">
    ...
    <div class="content position-relative" style="height: calc(100vh - 120px)">
      ...
      <div id="menu-wrapper" style="height: 100%; padding: 5rem 1rem 1.2rem 1rem" class="w-100 d-flex gap-2 flex-wrap justify-content-center align-items-start overflow-scroll position-relative">
      </div>
    </div>
